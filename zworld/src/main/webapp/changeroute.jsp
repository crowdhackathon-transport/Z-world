    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function init() {
                ...
                document.getElementById('routeCoo').value = already_route_nodes;
                console.log(already_route_nodes);

                function routechanged(e) {
                    console.log("epiasa to event");
                    document.getElementById('routeCoo').value = "";
                    var route_nodes = "LINESTRING(";
                    ...
                    document.getElementById('routeCoo').value = route_nodes;
                            ...
                            <div class="col-md-12">
                                <div class="box box-success">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">Χάρτης διαδρομής Α8</h3>
                                    </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <form name="" method="POST" action="#">
                                            <input type="hidden" id="routeCoo" name="routeCoo" value="">
